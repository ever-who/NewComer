...
public class ProximitySensor implements/* AccelerometerListener.OrientationListener,*/
    ...
    private Context mContext;//SPRD:add for Sensor setting
    ...
    public ProximitySensor(Context context, AudioModeProvider audioModeProvider) {
        ...
        mContext = context;//SPRD:add for Sensor setting
    }
   ...
   /* @Override
    ...
    public void onInCallShowing(boolean showing) {
        ...
        // If we stopped showing because the screen is off, we still consider that showing.
             ...
             * @Orig:else if (mPowerManager.isScreenOn()) {
             * @ { */
        } else {
            /* @}*/
            mUiShowing = false;
    ...
    private void updateProximitySensorMode() {
        /* SPRD: add for Sensor setting @{ */
        if(mContext != null){
            boolean isSensorEnable = Settings.System.getInt(mContext.getApplicationContext().getContentResolver()
                    , "plsensor", 1) == 1 ? true:false;
            if(!isSensorEnable){
                Log.i(this, "Sensor is disable,just return!");
                return;
            }
        }
        /* @} */
            ...
            synchronized (mProximityWakeLock) {
                ...
                if (mIsPhoneOffhook && !screenOnImmediately) {
                    ...
                    if (mProximityWakeLock.isHeld()) {
                        ...
                        /* SPRD: add for bug388161 @{ */
                        boolean maybeHorizontal = horizontal ||
                                (mOrientation == AccelerometerListener.ORIENTATION_UNKNOWN);
                        if(maybeHorizontal){
                            flags = 0;
                        }
