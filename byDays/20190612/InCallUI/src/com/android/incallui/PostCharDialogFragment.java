...
public class PostCharDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            mCallId = savedInstanceState.getInt(KEY_CALL_ID);
            mPostDialStr = savedInstanceState.getString(KEY_POST_DIAL_STR);
        }
        /* @}*/
    ...
    /* SPRD: add for Bug307590 @ { */
    public static String KEY_CALL_ID ="call_id";
    public static String KEY_POST_DIAL_STR ="post_dial_str";
    ...
    public void onSaveInstanceState(Bundle outState){
        ...
        outState.putInt(KEY_CALL_ID, mCallId);
        outState.putString(KEY_POST_DIAL_STR, mPostDialStr);
    }
    /* @}
     */
}
