...
public class CallCommandClient {
    ...
    public void answerCall(int callType , int callId) {//add for bug 713095
        Log.i(this, "answerCall: " + callId);
        ...
        try {
            mCommandService.answerVoicCall(callType, callId);
        } catch (RemoteException e) {
            Log.e(this, "Error answering call.", e);
        }
    }
    ...
    public void speaker(boolean onOff) {
        if (mCommandService == null) {
            Log.e(this, "Cannot speaker(boolean onOff); CallCommandService == null");
            return;
        }
        try {
            Log.v(this, "speaker(boolean onOff)");
    ...
    public void setSprdService(ISprdCallCommandService service) {
        mSprdCommandService = service;
    }

    public void silenceRinger(){
        if (mSprdCommandService == null) {
            Log.w(this, "Cannot silenceRinger(); mSprdCommandService == null");
            return;
        }
        try {
            Log.d(this, "silenceRinger()");
            mSprdCommandService.silenceRinger();
        } catch (RemoteException e) {
            Log.e(this, "Error on silenceRinger().", e);
        }
    }
    ...
    public boolean isVideoCall(){
        ...
        if (mSprdCommandService == null) {
            Log.w(this, " isVideoCall(); mSprdCommandService == null");
            return isVideo;
        }
        try {
            Log.d(this, "isVideoCall()");
            isVideo = mSprdCommandService.isVideoCall();
        } catch (RemoteException e) {
            Log.e(this, "Error on isVideoCall().", e);
        }
        return isVideo;
    }
    ...
    public boolean isRingtonePlaying(){
        ...
        if (mSprdCommandService == null) {
            Log.w(this, " isRingtonePlaying(); mSprdCommandService == null");
            return isPlaying;
        }
        try {
            Log.d(this, "isRingtonePlaying()");
            isPlaying = mSprdCommandService.isRingtonePlaying();
        } catch (RemoteException e) {
            Log.e(this, "Error on isRingtonePlaying().", e);
        }
        return isPlaying;
    }
    ...
    public void speakerOnAfterAnswer(){
        ...
        try {
            mSprdCommandService.speakerOnAfterAnswer();
        } catch (RemoteException e) {
            Log.e(this, "Error on speakerOnAfterAnswer().", e);
        }
    }
    /* @} */ 
