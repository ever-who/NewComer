...
public class CallerInfoAsyncQuery {
    ...
    /** SPRD: modify true to false to use our own geocode provider */
    //private static final boolean ENABLE_UNKNOWN_NUMBER_GEO_DESCRIPTION = /*true*/GeocodeHelper.isSupportGoogleGeocode();
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            if (mCallerInfo == null) {
                ...
                if ((cw.event == EVENT_EMERGENCY_NUMBER)
                        || PhoneNumberUtils.isEmergencyNumber(cw.number)) {
                    ...
                    //GeocodeHelper.setSearchNumber(cw.number);
    ...
    public static CallerInfoAsyncQuery startQuery(int token, Context context, String number,
        ...
        cw.cookie = cookie;
        cw.number = number;
        /* SPRD: Bug 631002 voice mail number will show for both SIM card   {*/
        int phoneId = 0;
        if (cookie instanceof CallIdentification) {
            phoneId =( (CallIdentification)cookie).getPhoneId();
        }
        /* Bug 631002 end @} */
        // check to see if these are recognized numbers, and use shortcuts if we can.
        /* SPRD: SPRD: modify for performance optimization */
