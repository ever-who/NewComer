...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadPresenter.DialpadUi>
    ...
    protected DTMFKeyListener mDialerKeyListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(SprdUtils.UNIVERSE_UI_SUPPORT){
            parent = inflater.inflate(R.layout.dialpad_view_stub_sprd, container, false);
            mDialpadStub = (ViewStub) parent.findViewById(R.id.dialpadStub);
        } else {
            parent = inflater.inflate(R.layout.dtmf_twelve_key_dialer_view, container, false);
    ...
    public void setVisible(boolean on) {
        if(SprdUtils.UNIVERSE_UI_SUPPORT){
            if (on) {
                if(mDialpadStub != null && mDialpadView == null){
                    initDialpadViews();
                    mDialpadView.setVisibility(View.VISIBLE);
                } else if(mDialpadView != null){
                    mDialpadView.setVisibility(View.VISIBLE);
                }
     ...
     */
    public /* package */ boolean onDialerKeyDown(KeyEvent event) {
    ...
    private void initDialpadViews(){
        View parent = mDialpadStub.inflate();
        mDialpadView = parent.findViewById(R.id.dtmf_twelve_key_dialer_view);
        mDtmfDialerField = (EditText) parent.findViewById(R.id.dtmfDialerField);
        if (mDtmfDialerField != null) {
            mDialerKeyListener = new DTMFKeyListener();
            mDtmfDialerField.setKeyListener(mDialerKeyListener);
