 ...
 */
public final class SimAccountsListAdapter extends BaseAdapter {
    private final LayoutInflater mInflater;
    private final List<AccountWithDataSet> mAccounts;
    private final AccountTypeManager mAccountTypes;
    private final Context mContext;

    public SimAccountsListAdapter(Context context) {
        mContext = context;
        mAccountTypes = AccountTypeManager.getInstance(context);
        mAccounts = getSimAccounts();
        mInflater = LayoutInflater.from(context);
    }

    private List<AccountWithDataSet> getSimAccounts() {
	return new ArrayList<AccountWithDataSet>(mAccountTypes.getSimAccounts());
    }
