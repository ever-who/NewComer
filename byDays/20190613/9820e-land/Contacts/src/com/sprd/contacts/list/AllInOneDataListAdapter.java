...
public class AllInOneDataListAdapter extends ContactEntryListAdapter {
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
      ...
      //SPRD:632419 Contact arrangement disorder,when adding a contact from message
...
//		view.getPhotoView().setVisibility(View.GONE);
		view.setDefaultPhotoViewSize(0);
		view.getDataView().setTextSize(27);
		view.setDataViewWidthWeight(12);
		view.setGapBetweenImageAndText(0);
/*** wanglei 20190329 add end ***/
    ...
    protected void bindPhoto(final ContactListItemView view, Cursor cursor) {
        ...
        String isSdn = cursor.getString(cursor.getColumnIndex(RawContacts.SYNC1));
        ...
        if (accountType != null
            ...
            getPhotoLoader().loadThumbnail(view.getPhotoView(), photoId, false, null,
                    getPhotoLoader().getDefaultPhotoProviderForAccount(mContext, account, "sdn".equals(isSdn)));
        } else {
