...
public class AllInOneDataPickerFragment extends ContactEntryListFragment<ContactEntryListAdapter>
    ...
    private ContactListItemView.PhotoPosition mPhotoPosition =
            ContactListItemView.getDefaultPhotoPosition(true);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (activity != null && activity instanceof ContactSelectionMultiTabActivity) {
            if (((ContactSelectionMultiTabActivity)activity).mCenterSkView != null) {
                if (data == null || (data != null && data.getCount() == 0)) {
                    ((ContactSelectionMultiTabActivity)activity).mCenterSkView.setText("");
                }
            }
        }
    }
