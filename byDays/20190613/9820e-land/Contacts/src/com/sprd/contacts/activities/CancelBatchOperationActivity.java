    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
		...
		final AlertDialog.Builder builder = new AlertDialog.Builder(this)
		    ...
		    .setPositiveButton(android.R.string.ok,new DialogInterface.OnClickListener() {
			    public void onClick(DialogInterface dialog, int which) {
				final Intent intent=new Intent(CancelBatchOperationActivity.this, BatchOperationService.class);
				intent.putExtra(BatchOperationService.KEY_NOTIFICATION_TAG, mTag);
				intent.putExtra(BatchOperationService.KEY_MODE, BatchOperationService.MODE_CANCEL);
				startService(intent);
				finish();
			    }
			})
