        ...
        for (RawContactDelta state : set) {
            ...
            for (ContentValues cv : ret) {
                ...
                if (Phone.CONTENT_ITEM_TYPE.equals(mimeType)
                    ...
                    //SPRD: add for bug674619, java.lang.ArrayIndexOutOfBoundsException
                    if (valueType.equals(String
                            .valueOf(Phone.TYPE_OTHER))) {
                        if (OtherNumberIndex <= 1) {
                            OtherNumberTpye[OtherNumberIndex++] = valueType;
                        }
                    } else if (valueType.equals(String
                            .valueOf(Phone.TYPE_CUSTOM))) {
                        if (CustomNumberIndex <= 1) {
            ...
            if (!TextUtils.isEmpty(OtherNumberTpye[1])
            ...
            if (!TextUtils.isEmpty(OtherNumberTpye[0])
                    && (TextUtils.isEmpty(numberType[0])) && !hasName) {
                toastId = R.string.only_other_number_type;
                return toastId;
            }
        }
        return toastId;
