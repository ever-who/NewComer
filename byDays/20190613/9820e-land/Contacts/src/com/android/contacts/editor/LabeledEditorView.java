...
public abstract class LabeledEditorView extends LinearLayout implements Editor, DialogShowingView {
    ...
    protected void onFinishInflate() {
        ...
        mDeleteContainer.setFocusable(true);
    ...
    private void setupDeleteButton() {
        if (mIsDeletable) {
            ...
            mDelete.setImageResource(R.drawable.ic_clear);
            mDelete.setEnabled(!mReadOnly && isEnabled());
            mDeleteContainer.setOnFocusChangeListener(new OnFocusChangeListener() {
                @Override
                public void onFocusChange(View arg0, boolean arg1) {
                    if (arg1) {
                        mDelete.setImageResource(R.drawable.ic_clear_white);
                    } else {
                        mDelete.setImageResource(R.drawable.ic_clear);
                    }
                }
    ...
    private Dialog createCustomDialog() {
        ...
        */
        ...
        //SPRD:Bug 634959 Display type and save type isn't the same while cancel custom dialog
            ...
            if (convertView == null) {
                ...
                */
                ...
                if (UniverseUtils.UNIVERSEUI_SUPPORT){
                    ...
                    textView.setTextSize(mContext.getResources()
