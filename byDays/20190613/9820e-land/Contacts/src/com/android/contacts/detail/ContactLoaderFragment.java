...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
    ...
    private final LoaderManager.LoaderCallbacks<Contact> mDetailLoaderListener =
        ...
        public void onLoadFinished(Loader<Contact> loader, Contact data) {
            ...
            if (data.isError()) {
                ...
                /*
                * SPRD:
                *   Bug 313154 IllegalArgumentException cause by TransactionTooLargeException
                * @orig
    ...
    /* SPRD: Add for Bug630241, The DUT fails to select the default ring tone while the picked ring tone is unavailable. @} */
    private HandlerThread handlerThread;
    private static final int MESSAGE_PICK_RINGTONE = 1;

    private void doPickRingtone() {
        handlerThread = new HandlerThread("PickRingtone");
        handlerThread.start();
        Handler handler = new Handler(handlerThread.getLooper()) {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case MESSAGE_PICK_RINGTONE:
                        pickRingtone();
                        break;
                }
            }
        };
        handler.sendEmptyMessage(MESSAGE_PICK_RINGTONE);
    }
    /* @} */
    ...
    private void pickRingtone() {
        ...
        */
        ...
        if (mCustomRingtone != null) {
            ...
            //SPRD: Add for Bug630241, The DUT fails to select the default ring tone while the picked ring tone is unavailable.
            Cursor cursor = mContext.getContentResolver().query(ringtoneUri, null, null, null, null);
