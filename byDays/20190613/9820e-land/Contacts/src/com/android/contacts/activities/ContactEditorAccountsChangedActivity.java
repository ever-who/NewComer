...
public class ContactEditorAccountsChangedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * SPRD:Bug874954 it show blank when lighten screen
         * @{
         */
        ...
        Log.e(TAG,
                "onCreate : " + "hasExtra = " + getIntent().hasExtra(Constants.INTENT_KEY_ACCOUNTS)
                        + " accounts = " + accounts);
        if (numAccounts < 0) {
        ...
        if (numAccounts >= 2) {
            ...
            */
            ...
            textView.setText(getString(R.string.no_account_to_edit));
    ...
    */
    ...
    //SPRD: add for bug648037, click menu for 2 times, the focus disappear
