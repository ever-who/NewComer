...
public class StructuredNameEditorView extends TextFieldsEditorView {
    ...
    */
    @Override
    public void setValues(DataKind kind, ValuesDelta entry, RawContactDelta state,
            boolean readonly, ViewIdGenerator vig) {
        setValues(kind, entry, state, readonly, vig, false);
    }
    

    public void setValues(DataKind kind, ValuesDelta entry, RawContactDelta state, boolean readOnly,
            ViewIdGenerator vig, boolean isUpdatePhoto) {
        /*
         * @}
         */
    ...
    protected Parcelable onSaveInstanceState() {
         ...
         * @{
         */
        Log.e(TAG, "onSaveInstanceState mChanged = " + state.mChanged + " mSnapshot = "
                + state.mSnapshot);
         /*
         * @}
         */
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "onRestoreInstanceState mChanged = " + ss.mChanged + " mSnapshot = "
                    + ss.mSnapshot);
        }
         /*
         * @}
