...
public class GroupMembershipView extends LinearLayout
    ...
    public void setGroupMetaData(Cursor groupMetaData) {
        ...
        */
        if (!mCreatedNewGroup) {
            mCreatedNewGroup = isCreateNewGroup();
        }
        /*
        * @}
        */
    ...
    */
    private boolean isCreateNewGroup() {
        ...
        if (getContext() != null && ((Activity) getContext() instanceof ContactEditorActivity)) {
            newGroup = ((ContactEditorActivity) getContext()).getCreateNewGroup();
            ((ContactEditorActivity) getContext()).setCreateNewGroup(false);
            return newGroup;
        }
        return false;
    }
