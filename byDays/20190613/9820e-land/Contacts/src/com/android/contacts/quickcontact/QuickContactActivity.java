...
public class QuickContactActivity extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /**
         * SPRD:
         *  When click the desktop contacts,add bulk operations judgment.
         * @{
         */
         if (ContactsApplication.sApplication.isBatchOperation()
                 || ContactSaveService.mIsGroupSaving) {
             Toast.makeText(QuickContactActivity.this, R.string.toast_batchoperation_is_running,
                    ...
                    try {
                        if (index == 0) {
                            ...
                            if (action.getAlternateIntent() != null) {
                                /* SPRD: Bug 350475 no popup when the message is saved as a draft
                                 * orig:startActivity(action.getAlternateIntent()); @{ */
                                Intent smsIntent = action.getAlternateIntent();
