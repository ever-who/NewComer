...
*/
    ...
    private boolean mImportDialog = false;
    ...
    */
    ...
    private class ImportRequestConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            */
            ...
            // SPRD: Bug 652442 monkey test crash when import contacts
                ...
                */
                if (mIsBindService) {
                    ...
                    try {
                        ...
                        Log.d(LOG_TAG, "unbind VCardService fail");
                    }
                }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (!isFinishing()) {
                    ...
                    /*
                    * SPRD:
                    *   Bug 343652 JavaCrash  Unable to add window,is your activity running?
                    * @orig
    ...
    protected void onStop() {
        ...
        if(mImportDialog){
            mImportDialog = false;
            try{
                dismissDialog(R.id.dialog_select_import_type);
            }catch (IllegalArgumentException e){
                Log.d(LOG_TAG,"dimissDialog exception");
            }
            finish();
        }
    }
    ...
    */
    ...
    /**
     *  SPRD:
     *  Bug 636136 press hang up key during caching vcf file,import task will be cancel.
     *
    @Override
    public void onStop() {
    super.onStop();
    ...
    */
    ...
    // Disable transition because floating displaying windows may bring the
    // black screen from different tasks.
    @Override
    public void finish() {
        super.finish();
