...
public class AccountSelectionUtil {
    ...
    public static Dialog getSelectAccountDialog(Context context, int resId) {
        ...
        * @{
        */
        return getSelectAccountDialog(context, resId, null, null, false);
//        return getSelectAccountDialog(context, resId, null, null);
    ...
    public static Dialog getSelectAccountDialog(Context context, int resId,
        ...
        * @{
        */
        return getSelectAccountDialog(context, resId, onClickListener, null, false);
//        return getSelectAccountDialog(context, resId, onClickListener, null);
    ...
    /**
    * SPRD:
    * Add argument 'isDialogFragment' when porting from 4.1 to 4.3.
    * @{
    */
    public static Dialog getSelectAccountDialog(Context context, int resId,
            DialogInterface.OnClickListener onClickListener,
...
//            DialogInterface.OnCancelListener onCancelListener) {
        ...
        * @{
        */
        final ArrayList<AccountWithDataSet> writableAccountList = (ArrayList) accountTypes.getAccounts(true);
//        final List<AccountWithDataSet> writableAccountList = accountTypes.getAccounts(true);
        ...
        */
        ...
        final ArrayAdapter<AccountWithDataSet> accountAdapter =
                 ...
                 * @{
                 */
                new ArrayAdapter<AccountWithDataSet>(context, R.layout.account_selector_list_item,
                        accounts) {
    ...
    public static void doImport(Context context, int resId, AccountWithDataSet account) {
        switch (resId) {
            ...
            case R.string.import_from_sdcard: {
                 ...
                 * @{
                 */
                doImportFromSdCard(context, account, R.string.import_from_sdcard);
//                doImportFromSdCard(context, account);
            ...
            case R.string.import_from_phone: {
                doImportFromSdCard(context, account, R.string.import_from_phone);
                break;
            }
            /**
             * @}
     ...
     * @{
     */
    public static void doImportFromSdCard(Context context, AccountWithDataSet account, int deviceType) {
//    public static void doImportFromSdCard(Context context, AccountWithDataSet account) {
        ...
        if (account != null) {
             ...
             * @{
             */
            importIntent.putExtra("device_type", deviceType);
            /**
             * @}
             */
        }
