...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    public void changeDirectories(Cursor cursor) {
        ...
        invalidate();
        /**
         * SPRD:Bug 639393 it show differently when first search no result and second search
         */
    ...
    private void updateIndexer(Cursor cursor) {
      ...
      /**
        * SPRD:Bug 717093 monkey test, happen com.android.contacts exception: android.os.TransactionTooLargeException;
        * @{
        */
	try{
...
//        }
    ...
    */
    protected void bindQuickContact(final ContactListItemView view, int partitionIndex,
            ...
            int account_type_column, int account_name_column, int displayNameColumn) {
    /**
    * @}
    */
        long photoId = 0;
        ...
        if (photoId != 0 || photoUriColumn == -1) {
            ...
            */
            ...
            if (accountType != null
                ...
                getPhotoLoader().loadPhoto(quickContact, photoUri, -1, mDarkTheme, null,
    ...
    */
    ...
    public void checkAll(int offset) {
        ...
        for (; offset < count; ++offset) {
            ...
            Cursor item = (Cursor) getItem(offset);
            if (item != null) {
                contactId = item.getLong(0);
            }
            if (contactId != 0) {
                mCheckedItems.add(contactId);
                if (!mContactCache.containsCache(contactId)) {
                    mContactCache.addCacheItem(item, contactId);
                }
            }
        }
    }
