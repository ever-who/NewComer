...
public class MoreContactUtils {
    ...
    public static View createHeaderView(Context context, int textResourceId) {
        ...
        if (UniverseUtils.UNIVERSEUI_SUPPORT) {
            View view = View.inflate(context, R.layout.list_separator_new_ui,
                    null);
            view.setPadding(0, 0, 0, 0);
            TextView textView = (TextView) view.findViewById(R.id.title);
            textView.setText(context.getString(textResourceId));
            textView.setBackgroundResource(R.drawable.list_section_divider_holo_light_sprd);
            //bug 263922
            //textView.setTextColor(android.graphics.Color.WHITE);
            textView.setTextAppearance(context, R.style.SectionHeaderStyle);
