...
public final class PhoneNumberFormatter {
    ...
    private static class TextWatcherLoadAsyncTask extends
        ...
        protected PhoneNumberFormattingTextWatcher doInBackground(Void... params) {
            ...
            */
//            if (mKeeppAndw) {
//                return new PhoneNumberFormattingTextWatcher(mCountryCode, mKeeppAndw);
//            } else {
//                return new PhoneNumberFormattingTextWatcher(mCountryCode);
//            }
              return new PhoneNumberFormattingTextWatcher(mCountryCode);
        ...
        */
        ...
        public TextWatcherLoadAsyncTask(String countryCode, TextView textView, boolean isKeeppAndw) {
            mCountryCode = countryCode;
            mTextView = textView;
