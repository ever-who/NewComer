        ...
        try {
            ...
            */
            ...
            final String title = mService.getString(R.string.exporting_vcard_finished_title,
                    filename);
            doFinishNotification(title, null);
/*** BUG #47048 wanglei 20190425 add begin ***/
			Message message = Message.obtain();
			message.obj = new Object[] { mService, title };
			mHandler.sendMessage(message);
/*** BUG #47048 wanglei 20190425 add end ***/
        } finally {
            if (composer != null) {
                composer.terminate();
            }
    ...
    private void doProgressNotification(Uri uri, int totalCount, int currentCount) {
         ...
         *      DEFAULT_NOTIFICATION_TAG, mJobId, notification);
         */
...
/*** BUG #47048 wanglei 20190425 add begin ***/
	private static final Handler mHandler = new Handler(Looper.getMainLooper()) {
		...
		public void handleMessage(Message msg) {
			Object[] objectList = (Object[]) msg.obj;
			Context context = (Context) objectList[0];
