...
public class Contact {
    ...
    */
    ...
    public Contact(Uri requestedUri, Uri uri, Uri lookupUri, long directoryId, String lookupKey,
            ...
            boolean isUserProfile, String displayAccountName, String displayAccountType, boolean isSdnContact,
            boolean isFdnContact, int fdnPhoneId) {
    ...
    public Contact(Uri requestedUri, Contact from) {
         ...
         * @}
         */
        mIsFdnContact = from.mIsFdnContact;
        mFdnPhoneId = from.mFdnPhoneId;
    }
    ...
    */
    ...
    public boolean isSdnContact() {
        return mIsSdnContact;
    }
    /**
    * @}
    */
    public boolean isFdnContact() {
        return mIsFdnContact;
    }

    public int getFdnPhoneId() {
        return mFdnPhoneId;
    }
}
