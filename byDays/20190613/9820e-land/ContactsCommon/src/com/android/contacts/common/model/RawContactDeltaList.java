...
public class RawContactDeltaList extends ArrayList<RawContactDelta> implements Parcelable {
    ...
    public static RawContactDeltaList fromQuery(Uri entityUri, ContentResolver resolver,
        ...
        /* SPRD: add for Bug 647157 Monkey CRASH: com.android.contacts (java.lang.NullPointerException) @ */
        Cursor mCursor = resolver.query(entityUri, null, selection, selectionArgs, sortOrder);
        if(mCursor != null){
            final EntityIterator iterator = RawContacts.newEntityIterator(mCursor);
            //SPRD: add for bug653246, JavaCrash,log:java.lang.NullPointerException
            if (iterator == null) {
