...
import android.graphics.Color;//bird add by wucheng 20190321
    ...
    private void configureSelection(
        ...
        switch (filter.filterType) {
            case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS: {
                ...
                */
                ...
                for (AccountWithDataSet account : accounts) {
                    ...
                    if(mListRequestModeSelection != null
                            ...
                            && ("sprd.com.android.account.usim".equals(account.type)|| "sprd.com.android.account.sim".equals(account.type))) {
                        selection.append(" AND " + RawContacts.SYNC1 + "!='sdn'");
                    }
                    if(mListRequestModeSelection != null  &&( "mode_export_to".equals(mListRequestModeSelection)||"mode_dilar".equals(mListRequestModeSelection))
                ...
                * @}
                */
                if ("mode_dilar".equals(mListRequestModeSelection) ||
            ...
            case ContactListFilter.FILTER_TYPE_ACCOUNT: {
                ...
                */
                ...
                if (mListRequestModeSelection != null
                    ...
                    if (isSearchMode || isCustomFilterForPhoneNumbersOnly() ||
                            (mAddGroupMemSelection != null && !mAddGroupMemSelection.isEmpty())) {
                        selection.append(" AND " + RawContacts.SYNC1);
                    } else {
                        selection.append(RawContacts.SYNC1);
                    }
...
//        }
        ...
        Log.d("hjc_contact","bindView partition="+partition+",position="+position+",getUpperCaseQueryString="+getUpperCaseQueryString());
        ...
        if (isQuickContactEnabled()) {
            ...
            * @{
            */
            Log.d("hjc_contact", "bindView: isQuickContactEnabled="+isQuickContactEnabled());//mark
            bindQuickContact(view, partition, cursor, ContactQuery.CONTACT_PHOTO_ID,
                    ContactQuery.CONTACT_PHOTO_URI, ContactQuery.CONTACT_ID,
...
//		String name = cursor.getString(ContactQuery.CONTACT_DISPLAY_NAME);
//		int mode = position%3;
//        int color = Color.parseColor("#ffea9101");
//        switch (mode){
//            case 0:
//                color = Color.parseColor("#ffea9101");
//                break;
//            case 1:
//                color = Color.parseColor("#ff57a708");
//                break;
//            case 2:
//                color = Color.parseColor("#ff1d7fd8");
//                break;
//
//            default:
//                break;
...
//                .fontSize(20)
//                .endConfig()
//                .buildRoundRect(name.substring(name.length()-1,name.length()), color, 5);
//        view.getPhotoView().setImageDrawable(drawable);
        /**
        * SPRD:
        *
        * @{
...
/*** BUG #47348 wanglei 20190507 add begin ***/
			bindSimPhoto(view, partition, cursor);
/*** BUG #47348 wanglei 20190507 add end ***/
        } else {
			bindSimPhoto(view, partition, cursor);
		}
		//bird add by wucheng 2019032 end	
        /**
        * @}
        */
