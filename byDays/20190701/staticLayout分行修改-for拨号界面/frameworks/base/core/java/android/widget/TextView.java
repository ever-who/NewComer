...
import android.text.BirdDynamicLayout;//add by BIRD@hujingcheng 20190625
...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    public TextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        // SPRD: save fontFamily attribute
        mFamilyName = fontFamily;
    ...
    public void setTypeface(Typeface tf, int style) {
        if (style > 0) {
            ...
            } else if (tf == null && mFamilyName != null) {
                // If this view has setted a fontFamily attribute, restore it.
                tf = Typeface.create(mFamilyName, style);
            }
            /* @} */
            setTypeface(tf);
        }
    ...
    /**
     * SPRD: used to save fontFamily attribute
     */
    ...
    public void setGravity(int gravity) {
        //mark
        if(DBG){
            Log.d(TAG, "setGravity() called with: gravity = [" + gravity + "]");
        }
        ...
        mGravity = gravity;
        if(DBG){
            Log.d(TAG, "setGravity() called with: gravity = ["+gravity+"]"+", mGravity="+mGravity+",newLayout="+newLayout);
        }
    ...
    private void setText(CharSequence text, BufferType type,
        ...
        if ((Typeface.mUserSetTf != null && getTypeface() == null) ||//set a new font
            (getTypeface() != null
                     ...
                     && ((Typeface.mUserSetTf == null && Typeface.mPreUserSetTf != null) 
                         || (Typeface.mUserSetTf != null && !getTypeface().equals(Typeface.mUserSetTf))))) {
    ...
    public boolean onPreDraw() {
        ...
        // SPRD: check visible of Window
        //if (this instanceof ExtractEditText && hasSelection() && mEditor != null) {
        if (this instanceof ExtractEditText && hasSelection() && mEditor != null && getWindowVisibility() == View.VISIBLE) {
            mEditor.startSelectionActionMode();
        }
            ...
            case KeyEvent.KEYCODE_ENTER:
                if (event.hasNoModifiers()) {
                    ...
                    if ((event.getFlags() & KeyEvent.FLAG_EDITOR_ACTION) != 0
                        ...
                        if (!hasOnClickListeners()) {
                            /*
                             * SPRD: Bug 389738 - Avoid crash if the view can't
                             * take focus.
                             */
                            ...
                            if (v == null || !hasFound) {
                                ...
                                & KeyEvent.FLAG_EDITOR_ACTION) != 0) {
                                    // No target for next focus, but make sure
                                    // the IME if this came from it.
                                    InputMethodManager imm = InputMethodManager.peekInstance();
                                    if (imm != null && imm.isActive(this)) {
                                        imm.hideSoftInputFromWindow(getWindowToken(), 0);
                                    }
    ...
    protected void makeNewLayout(int wantWidth, int hintWidth,
        ...
        //mark
        if(DBG){
            Log.d(TAG, "makeNewLayout: alignment="+alignment+",mSingleLine="+mSingleLine+",mLayout="+mLayout
                    +",testDirChange="+testDirChange+",oldDir="+oldDir+",mTextDir="+mTextDir+"textview.this="+this);
        }
        ...
        //mark
        if(DBG){
            Log.d(TAG, "makeNewLayout 2: mHint="+mHint+",mLayout="+mLayout
                    +",hintBoring="+hintBoring+",bringIntoView="+bringIntoView+",mTextDir="+mTextDir+"textview.this="+this);
        }
        if (mHint != null) {
        ...
        //mark
        if(DBG){
            Log.d(TAG, "makeNewLayout 3: mLayout="+mLayout+",mLayout.getParagraphDirection(0)="+mLayout.getParagraphDirection(0)
                    +",bringIntoView="+bringIntoView+",testDirChange="+testDirChange+",mEllipsize="+mEllipsize+",oldDir="+oldDir+"textview.this="+this);
        }
    ...
    /**
     * add by hujingcheng for override 20190625
     * @return
     */
    ...
    private Layout makeSingleLayout(int wantWidth, BoringLayout.Metrics boring, int ellipsisWidth,
        ...
        //mark
        if(DBG){
            Log.d(TAG, "makeSingleLayout() called with: wantWidth = [" + wantWidth + "], boring = [" + boring + "], ellipsisWidth = [" + ellipsisWidth + "], alignment = [" + alignment + "], shouldEllipsize = ["
                    + shouldEllipsize + "], effectiveEllipsize = [" + effectiveEllipsize + "], useSaved = [" + useSaved + "]"+",mText instanceof Spannable:"+(mText instanceof Spannable)+",textview.this"+this);
        }
        Layout result = null;
        if (mText instanceof Spannable) {
            /* add by hujingcheng customize DynamicLayout 20190625 for dial ui */
            result=getCustomizeDynamicLayout(mText, mTransformed, mTextPaint, wantWidth,
            ...
            /* add by hujingcheng customize DynamicLayout 20190625 for dial ui end */
